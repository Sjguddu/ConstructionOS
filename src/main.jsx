...
function App() {
  ...
  const renderModule = () => {
    if (active === 'Overview') return <Overview projects={projects} total={total} avg={avg} filtered={filtered} setSelected={setSelected} onCreate={() => setShowCreate(true)} />;
